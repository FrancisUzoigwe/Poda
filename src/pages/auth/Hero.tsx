            ...
            <div className="w-full bg-[#F8F9FB] min-h-[90vh] flex justify-center">
                <div className="w-[95%] flex justify-between items-center max-lg:flex-col">
                    <div className="w-[500px] max-lg:w-full ">
                        <div className="font-[Blud] text-[55px] max-md:text-[40px] max-lg:leading-[55px] max-lg:mt-5 w-[500px] leading-[65px] mb-4 max-lg:w-full max-md:text-center">Podcasting and Audio Books Simplified For Everyone.</div>
